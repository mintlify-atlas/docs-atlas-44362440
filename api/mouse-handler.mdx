...
| `IsLeftMouseClicked()` | `bool` | `true` on the frame the left button transitions to pressed |
| `IsRightMouseClicked()` | `bool` | `true` on the frame the right button transitions to pressed |
...
Returns `true` on the frame the left button transitions from unpressed to pressed. Useful for single-fire actions such as selecting a menu item or firing a projectile.

### `bool IsRightMouseClicked()`

Returns `true` on the frame the right button transitions from unpressed to pressed. Mirrors `IsLeftMouseClicked()` for the right button.
