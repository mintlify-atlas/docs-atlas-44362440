...
sidebarTitle: "Colors"
description: "Fazen2d's ConsoleColor enum and Color class map Windows console attributes to readable names. Reference for all color constants and the Color utility class."
---
