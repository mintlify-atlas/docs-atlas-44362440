---
title: "Text Class — Unicode String Rendering API"
sidebarTitle: "Text"
...
| `translate(float dx, float dy)` | `void` | Adds `dx` to X and `dy` to Y. No bounds checking is performed — the caller must keep the string within console bounds. |
